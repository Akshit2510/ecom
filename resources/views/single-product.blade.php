                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab" href="#tabs-1" role="tab">
                                <div class="product__thumb__pic set-bg" data-setbg="{{ url('storage/uploads/product').'/'.$product->product_image }}">
                                </div>
                            </a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tabs-1" role="tabpanel">
                            <div class="product__details__pic__item">
                                <img src="{{ url('storage/uploads/product').'/'.$product->product_image }}" alt="">
                            </div>
                        </div>
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-lg-8">
                    <div class="product__details__text">
                        ...
                        <h3>{{ formatAmount($product->price,true) }}</span></h3>
